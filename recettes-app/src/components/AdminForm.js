    ...
    return (
        <div className='card'>
            <form className='admin-form'>
                ...
                <input value={recette.image} onChange={e => handleChange(e, key)} type='text' name='image' placeholder="Nom de la recette"/>
                ...
                <textarea value={recette.instructions} onChange={e => handleChange(e, key)} name='instructions' row='15' placeholder='Liste des instructions' />
